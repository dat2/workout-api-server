...
pub fn create_user<'a>(conn: &PgConnection, new_email: &'a str, new_username: &'a str, new_password: &'a str) -> errors::Result<User> {
  use schema::users;
...
pub fn find_user(conn: &PgConnection, query_username: &str, query_password: &str) -> errors::Result<User> {
  use schema::users::dsl::*;
